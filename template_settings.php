                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label settingsAboutMe">About Me</label>
                                    <div class="col-sm-8">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label socialTwitter">Twitter</label>
                                    <div class="col-sm-8">
                                        <input type="text" id="twitterSettings" class="form-control social" id="inputEmail3" placeholder="">
                                        <span class="labelURL">https://www.twitter.com/</span><span class="" id="twitterSettingsLabel"></span>
                                    </div>
                                </div>

                                 <div class="form-group">
                                    <label for="inputEmail3"  class="col-sm-3 control-label socialGoogle">Google +</label>
                                    <div class="col-sm-8">
                                        <input type="text" id="googleSettings" class="form-control social" id="inputEmail3" placeholder="">
                                        <span class="labelURL">https://plus.google.com/+</span><span class="" id="googleSettingsLabel"></span>
                                    </div>
                                </div>

                                 <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-3 control-label socialInstagram">Instagram</label>
                                    <div class="col-sm-8">
                                        <input type="text" id="instagramSettings" class="form-control social" id="inputEmail3" placeholder="">
                                        <span class="labelURL">https://www.instagram.com/</span><span class="" id="instagramSettingsLabel"></span>
                                    </div>
                                </div>
