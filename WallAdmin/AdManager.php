                  ...
                  <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                      <div class="box-header">
                        <h3 class="box-title">Create Feed Advertisement</h3>
                      </div>
                      <!-- /.box-header -->
                      <!-- form start -->
                      ...
                      <div class="box-body">
                        <label for="exampleInputPassword1"> Advertisement Type</label>
                    ...
                    <div class="box box-success">
                      ...
                      <div class="box-body">
                        <div class="blockPreview">
                          ...
                          <div> <a href="#" id="suggest_title" class="suggest_title" target="blank">Ad Title</a></div>
